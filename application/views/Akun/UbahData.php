...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('css') ?>/Alpha_header.css">
...
<body>
    <div class="header">
        ...
        <div class="nav_bawah">
            <span class="Catalog">
                <ul class="navlink">
                    <li class="geser"><a id="Black" href="#">TERBARU</a></li>
                    <li class="geser"><a id="Black" href="#">PAKAIAN</a></li>
                    <li class="geser"><a id="Black" href="#">SEPATU</a></li>
                    <li class="geser"><a id="Black" href="#">TAS</a></li>
                    <li class="geser"><a id="Black" href="#">JAM & ASESORIS</a></li>
                    <li class="geser"><a id="Black" href="#">BAJU MUSLIM</a></li>
                    <li class="geser"><a id="Black" href="#">SPORTS</a></li>
                    <li class="geser"><a id="Black" href="#">BATIK</a></li>
                    <li class="geser"><a id="Black" href="#">ZALOCAL</a></li>
                    <li class="geser"><a id="Black" href="#">FLAGSHIP STORES</a></li>
                    <li class="geser"><a id="Black" href="#">BRANDS</a></li>
                </ul>
                <a class="Position_right" id="Red" href="#">SALE</a>
            </span>
        </div>
    </div>
        ...
        <div class="Body_Tamplate_akun">
            ...
            <div class="col-lg-9">
                <div class="card">
                    ...
                    <div class="card-body">
                    <form method="post" action="<?php echo site_url('dbeditakun') ?>">
                        <input type="hidden" class="form-control" id="formGroupExampleInput" placeholder="id_pembeli" name="id_pembeli" value="<?php echo $d->id_pembeli ?>"  required>
                        <input type="hidden" class="form-control" id="formGroupExampleInput" placeholder="alamat" name="alamat" value="<?php echo $d->alamat ?>"  required>
                        <label for="formGroupExampleInput">Email</label>
                        <input type="form-group" class="form-control" id="formGroupExampleInput" placeholder="Email" name="email" value="<?php echo $d->email ?>"  required>
                        <div class="form-group">
                        <label for="formGroupExampleInput">Jenis Kelamin</label>
                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Jenis Kelamin" name="gender" value="<?php echo $d->gender ?>" required >
                        </div>
                        <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="formGroupExampleInput2"  name="tgllahir" value="<?php echo $d->tgllahir ?>" required>
                        </div>
                        </div>
                        <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">BATALKAN</button>
                        <input  type="submit" class="btn btn-primary" id="simpan" value="SIMPAN PILIHAN" placeholder="Simpan">
                        </div>
                        </form>                                                               
                    </div>
                </div>               
    ...
    <div class="Icon-Partner container">
        <div class="company">
            <p>A COMPANY BY</p>
            <svg class=""></svg>
        </div>
