...
<head>
    ...
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"
        ...
        <link rel="stylesheet" href="http://localhost/Tubes2_zalora//css/">
...
<body>
    ...
    <div class="bodypage">
        ...
        <div class="b-seo">
            <style>
        #S_e_oText{text-align: center}
        #S_e_oText h1, #S_e_oText h2{font-size: 16px;font-weight: 700}
        .Belanja{
        display: flex;
            ...
            <div class="Belanja">
                ...
                <p>Kami juga memberikan layanan GRATIS pengembalian jika barang yang Anda pesan tidak sesuai. Disaat Anda mencari kebutuhan fashion pria, ZALORA Indonesia adalah toko fashion online yang paling tepat untuk Anda. Selamat berbelanja!</p></div>
            </div>
        </div>
        </div>
    </div>
